const SPECIES = [
  ...
  {id:659,name:'Bunnelby'},{id:660,name:'Diggersby'},{id:661,name:'Fletchling'},
  {id:662,name:'Fletchinder'},{id:663,name:'Talonflame'},{id:664,name:'Scatterbug'},
  {id:665,name:'Spewpa'},{id:666,name:'Vivillon'},{id:667,name:'Litleo'},
  {id:668,name:'Pyroar'},{id:669,name:'Flabébé'},{id:670,name:'Floette'},
  {id:671,name:'Florges'},{id:672,name:'Skiddo'},{id:673,name:'Gogoat'},
  {id:674,name:'Pancham'},{id:675,name:'Pangoro'},{id:676,name:'Furfrou'},
  {id:677,name:'Espurr'},{id:678,name:'Meowstic'},{id:679,name:'Honedge'},
  {id:680,name:'Doublade'},{id:681,name:'Aegislash'},{id:682,name:'Spritzee'},
  {id:683,name:'Aromatisse'},{id:684,name:'Swirlix'},{id:685,name:'Slurpuff'},
  {id:686,name:'Inkay'},{id:687,name:'Malamar'},{id:688,name:'Binacle'},
  {id:689,name:'Barbaracle'},{id:690,name:'Skrelp'},{id:691,name:'Dragalge'},
  {id:692,name:'Clauncher'},{id:693,name:'Clawitzer'},{id:694,name:'Helioptile'},
  {id:695,name:'Heliolisk'},{id:696,name:'Tyrunt'},{id:697,name:'Tyrantrum'},
  {id:698,name:'Amaura'},{id:699,name:'Aurorus'},{id:700,name:'Sylveon'},
  {id:701,name:'Hawlucha'},{id:702,name:'Dedenne'},{id:703,name:'Carbink'},
  {id:704,name:'Goomy'},{id:705,name:'Sliggoo'},{id:706,name:'Goodra'},
  {id:707,name:'Klefki'},{id:708,name:'Phantump'},{id:709,name:'Trevenant'},
  {id:710,name:'Pumpkaboo'},{id:711,name:'Gourgeist'},{id:712,name:'Bergmite'},
  {id:713,name:'Avalugg'},{id:714,name:'Noibat'},{id:715,name:'Noivern'},
  {id:716,name:'Xerneas'},{id:717,name:'Yveltal'},{id:718,name:'Zygarde'},
  {id:719,name:'Diancie'},{id:720,name:'Hoopa'},{id:721,name:'Volcanion'},
  // Gen 7 (722-809)
  ...
  {id:731,name:'Pikipek'},{id:732,name:'Trumbeak'},{id:733,name:'Toucannon'},
  {id:734,name:'Yungoos'},{id:735,name:'Gumshoos'},{id:736,name:'Grubbin'},
  {id:737,name:'Charjabug'},{id:738,name:'Vikavolt'},{id:739,name:'Crabrawler'},
  {id:740,name:'Crabominable'},{id:741,name:'Oricorio'},{id:742,name:'Cutiefly'},
  {id:743,name:'Ribombee'},{id:744,name:'Rockruff'},{id:745,name:'Lycanroc'},
  {id:746,name:'Wishiwashi'},{id:747,name:'Mareanie'},{id:748,name:'Toxapex'},
  {id:749,name:'Mudbray'},{id:750,name:'Mudsdale'},{id:751,name:'Dewpider'},
  {id:752,name:'Araquanid'},{id:753,name:'Fomantis'},{id:754,name:'Lurantis'},
  {id:755,name:'Morelull'},{id:756,name:'Shiinotic'},{id:757,name:'Salandit'},
  {id:758,name:'Salazzle'},{id:759,name:'Stufful'},{id:760,name:'Bewear'},
  {id:761,name:'Bounsweet'},{id:762,name:'Steenee'},{id:763,name:'Tsareena'},
  {id:764,name:'Comfey'},{id:765,name:'Oranguru'},{id:766,name:'Passimian'},
  {id:767,name:'Wimpod'},{id:768,name:'Golisopod'},{id:769,name:'Sandygast'},
  {id:770,name:'Palossand'},{id:771,name:'Pyukumuku'},{id:772,name:'Type: Null'},
  {id:773,name:'Silvally'},{id:774,name:'Minior'},{id:775,name:'Komala'},
  {id:776,name:'Turtonator'},{id:777,name:'Togedemaru'},{id:778,name:'Mimikyu'},
  {id:779,name:'Bruxish'},{id:780,name:'Drampa'},{id:781,name:'Dhelmise'},
  {id:782,name:'Jangmo-o'},{id:783,name:'Hakamo-o'},{id:784,name:'Kommo-o'},
  {id:785,name:'Tapu Koko'},{id:786,name:'Tapu Lele'},{id:787,name:'Tapu Bulu'},
  {id:788,name:'Tapu Fini'},{id:789,name:'Cosmog'},{id:790,name:'Cosmoem'},
  {id:791,name:'Solgaleo'},{id:792,name:'Lunala'},{id:793,name:'Nihilego'},
  {id:794,name:'Buzzwole'},{id:795,name:'Pheromosa'},{id:796,name:'Xurkitree'},
  {id:797,name:'Celesteela'},{id:798,name:'Kartana'},{id:799,name:'Guzzlord'},
  {id:800,name:'Necrozma'},{id:801,name:'Magearna'},{id:802,name:'Marshadow'},
  {id:803,name:'Poipole'},{id:804,name:'Naganadel'},{id:805,name:'Stakataka'},
  {id:806,name:'Blacephalon'},{id:807,name:'Zeraora'},{id:808,name:'Meltan'},
  ...
  {id:819,name:'Skwovet'},{id:820,name:'Greedent'},{id:821,name:'Rookidee'},
  {id:822,name:'Corvisquire'},{id:823,name:'Corviknight'},{id:824,name:'Blipbug'},
  {id:825,name:'Dottler'},{id:826,name:'Orbeetle'},{id:827,name:'Nickit'},
  {id:828,name:'Thievul'},{id:829,name:'Gossifleur'},{id:830,name:'Eldegoss'},
  {id:831,name:'Wooloo'},{id:832,name:'Dubwool'},{id:833,name:'Chewtle'},
  {id:834,name:'Drednaw'},{id:835,name:'Yamper'},{id:836,name:'Boltund'},
  {id:837,name:'Rolycoly'},{id:838,name:'Carkol'},{id:839,name:'Coalossal'},
  {id:840,name:'Applin'},{id:841,name:'Flapple'},{id:842,name:'Appletun'},
  {id:843,name:'Silicobra'},{id:844,name:'Sandaconda'},{id:845,name:'Cramorant'},
  {id:846,name:'Arrokuda'},{id:847,name:'Barraskewda'},{id:848,name:'Toxel'},
  {id:849,name:'Toxtricity'},{id:850,name:'Sizzlipede'},{id:851,name:'Centiskorch'},
  {id:852,name:'Clobbopus'},{id:853,name:'Grapploct'},{id:854,name:'Sinistea'},
  {id:855,name:'Polteageist'},{id:856,name:'Hatenna'},{id:857,name:'Hattrem'},
  {id:858,name:'Hatterene'},{id:859,name:'Impidimp'},{id:860,name:'Morgrem'},
  {id:861,name:'Grimmsnarl'},{id:862,name:'Obstagoon'},{id:863,name:'Perrserker'},
  {id:864,name:'Cursola'},{id:865,name:'Sirfetch\'d'},{id:866,name:'Mr. Rime'},
  {id:867,name:'Runerigus'},{id:868,name:'Milcery'},{id:869,name:'Alcremie'},
  {id:870,name:'Falinks'},{id:871,name:'Pincurchin'},{id:872,name:'Snom'},
  {id:873,name:'Frosmoth'},{id:874,name:'Stonjourner'},{id:875,name:'Eiscue'},
  {id:876,name:'Indeedee'},{id:877,name:'Morpeko'},{id:878,name:'Cufant'},
  {id:879,name:'Copperajah'},{id:880,name:'Dracozolt'},{id:881,name:'Arctozolt'},
  {id:882,name:'Dracovish'},{id:883,name:'Arctovish'},{id:884,name:'Duraludon'},
  {id:885,name:'Dreepy'},{id:886,name:'Drakloak'},{id:887,name:'Dragapult'},
  {id:888,name:'Zacian'},{id:889,name:'Zamazenta'},{id:890,name:'Eternatus'},
  {id:891,name:'Kubfu'},{id:892,name:'Urshifu'},{id:893,name:'Zarude'},
  {id:894,name:'Regieleki'},{id:895,name:'Regidrago'},{id:896,name:'Glastrier'},
  {id:897,name:'Spectrier'},{id:898,name:'Calyrex'},{id:899,name:'Wyrdeer'},
  {id:900,name:'Kleavor'},{id:901,name:'Ursaluna'},{id:902,name:'Basculegion'},
  {id:903,name:'Sneasler'},{id:904,name:'Overqwil'},{id:905,name:'Enamorus'},
  // Gen 9 (906-1025)
  ...
  {id:915,name:'Lechonk'},{id:916,name:'Oinkologne'},{id:917,name:'Tarountula'},
  {id:918,name:'Spidops'},{id:919,name:'Nymble'},{id:920,name:'Lokix'},
  {id:921,name:'Pawmi'},{id:922,name:'Pawmo'},{id:923,name:'Pawmot'},
  {id:924,name:'Tandemaus'},{id:925,name:'Maushold'},{id:926,name:'Fidough'},
  {id:927,name:'Dachsbun'},{id:928,name:'Smoliv'},{id:929,name:'Dolliv'},
  {id:930,name:'Arboliva'},{id:931,name:'Squawkabilly'},{id:932,name:'Nacli'},
  {id:933,name:'Naclstack'},{id:934,name:'Garganacl'},{id:935,name:'Charcadet'},
  {id:936,name:'Armarouge'},{id:937,name:'Ceruledge'},{id:938,name:'Tadbulb'},
  {id:939,name:'Bellibolt'},{id:940,name:'Wattrel'},{id:941,name:'Kilowattrel'},
  {id:942,name:'Maschiff'},{id:943,name:'Mabosstiff'},{id:944,name:'Shroodle'},
  {id:945,name:'Grafaiai'},{id:946,name:'Bramblin'},{id:947,name:'Brambleghast'},
  {id:948,name:'Toedscool'},{id:949,name:'Toedscruel'},{id:950,name:'Klawf'},
  {id:951,name:'Capsakid'},{id:952,name:'Scovillain'},{id:953,name:'Rellor'},
  {id:954,name:'Rabsca'},{id:955,name:'Flittle'},{id:956,name:'Espathra'},
  {id:957,name:'Tinkatink'},{id:958,name:'Tinkatuff'},{id:959,name:'Tinkaton'},
  {id:960,name:'Wiglett'},{id:961,name:'Wugtrio'},{id:962,name:'Bombirdier'},
  {id:963,name:'Finizen'},{id:964,name:'Palafin'},{id:965,name:'Varoom'},
  {id:966,name:'Revavroom'},{id:967,name:'Cyclizar'},{id:968,name:'Orthworm'},
  {id:969,name:'Glimmet'},{id:970,name:'Glimmora'},{id:971,name:'Greavard'},
  {id:972,name:'Houndstone'},{id:973,name:'Flamigo'},{id:974,name:'Cetoddle'},
  {id:975,name:'Cetitan'},{id:976,name:'Veluza'},{id:977,name:'Dondozo'},
  {id:978,name:'Tatsugiri'},{id:979,name:'Annihilape'},{id:980,name:'Clodsire'},
  {id:981,name:'Farigiraf'},{id:982,name:'Dudunsparce'},{id:983,name:'Kingambit'},
  {id:984,name:'Great Tusk'},{id:985,name:'Scream Tail'},{id:986,name:'Brute Bonnet'},
  {id:987,name:'Flutter Mane'},{id:988,name:'Slither Wing'},{id:989,name:'Sandy Shocks'},
  {id:990,name:'Iron Treads'},{id:991,name:'Iron Bundle'},{id:992,name:'Iron Hands'},
  {id:993,name:'Iron Jugulis'},{id:994,name:'Iron Moth'},{id:995,name:'Iron Thorns'},
  {id:996,name:'Frigibax'},{id:997,name:'Arctibax'},{id:998,name:'Baxcalibur'},
  {id:999,name:'Gimmighoul'},{id:1000,name:'Gholdengo'},{id:1001,name:'Wo-Chien'},
  {id:1002,name:'Chien-Pao'},{id:1003,name:'Ting-Lu'},{id:1004,name:'Chi-Yu'},
  {id:1005,name:'Roaring Moon'},{id:1006,name:'Iron Valiant'},{id:1007,name:'Koraidon'},
  {id:1008,name:'Miraidon'},{id:1009,name:'Walking Wake'},{id:1010,name:'Iron Leaves'},
  {id:1011,name:'Dipplin'},{id:1012,name:'Poltchageist'},{id:1013,name:'Sinistcha'},
  {id:1014,name:'Okidogi'},{id:1015,name:'Munkidori'},{id:1016,name:'Fezandipiti'},
  {id:1017,name:'Ogerpon'},{id:1018,name:'Archaludon'},{id:1019,name:'Hydrapple'},
  {id:1020,name:'Gouging Fire'},{id:1021,name:'Raging Bolt'},{id:1022,name:'Iron Boulder'},
  {id:1023,name:'Iron Crown'},{id:1024,name:'Terapagos'},{id:1025,name:'Pecharunt'},
